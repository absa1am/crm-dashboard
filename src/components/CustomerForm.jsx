        ...
        <div className="d-flex justify-content-center m-5">
            <form className="w-50" onSubmit={handleOnSubmit}>
                <div className="mb-3">
                    ...
                    <input type="text" className="form-control" id="name" placeholder="John Doe" onChange={(e) => setName(e.target.value)} />
                </div>
                <div className="mb-3">
                ...
                <div className="mb-3">
                    ...
                    <input type="number" className="form-control" id="phone" placeholder="+880 1XXXXXXXXX" onChange={(e) => setPhone(e.target.value)} />
                </div>
                <div className="mb-3">
